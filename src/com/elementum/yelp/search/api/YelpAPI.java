package com.elementum.yelp.search.api;
...
public class YelpAPI {
	 ...
	 */
	public String searchForBusinesses(Request searchRequest) {
		OAuthRequest request = createOAuthRequest(SEARCH_PATH);
		request.addQuerystringParameter("term", searchRequest.what);
		request.addQuerystringParameter("location", searchRequest.where);
		request.addQuerystringParameter("limit",
				String.valueOf(searchRequest.max));
	...
	private String sendRequestAndGetResponse(OAuthRequest request) {
		...
		Log.i("YelpAPI", "Response " + response.getBody() + " ...");
